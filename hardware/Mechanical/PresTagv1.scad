...
version_string = "PresTagV1"; // imprinted in base and lid
pcb_min_thick = 0.4*25.4;
pogo_Xoffset = 4.5;
pogo_Yoffset = 11.135;

pogo_center = [pogo_Xoffset, pogo_Yoffset];
board_file = "PresTag-v3-Edge_Cuts.dxf";
...
module makePCB() {
   %linear_extrude(height = pcb_thick*25.4, center = true, convexity = 10)
